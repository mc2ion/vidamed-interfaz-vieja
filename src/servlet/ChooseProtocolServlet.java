...
/**
 * Servlet implementation class ChooseProtocolServlet
 */
@WebServlet(description = "servlet to generate reports", urlPatterns = { "/ChooseProtocolServlet" })
public class ChooseProtocolServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userE != null && perm ){
			try {
				...
				RequestDispatcher rd = getServletContext().getRequestDispatcher("/chooseProtocol.jsp");
