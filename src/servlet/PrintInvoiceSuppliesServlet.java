...
/**
 * Servlet implementation class PrintInvoiceSuppliesServlet
 */
@WebServlet(description = "servlet to log in users", urlPatterns = { "/PrintInvoiceSuppliesServlet" })
public class PrintInvoiceSuppliesServlet extends HttpServlet {
     ...
     */
    public PrintInvoiceSuppliesServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userE != null){
			...
			try {				
				...
				rd = getServletContext().getRequestDispatcher("/printInvoiceSupplies.jsp");			
