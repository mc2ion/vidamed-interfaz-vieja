 ...
 */
@WebServlet(description = "servlet to log in users", urlPatterns = { "/PrintEstimationDetailServlet" })
public class PrintEstimationDetailServlet extends HttpServlet {
     ...
     */
    public PrintEstimationDetailServlet() {
        super();
    }
