 ...
 */
@WebServlet(description = "servlet to generate reports", urlPatterns = { "/ListInterServlet" })
public class ListInterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userE != null && perm ){
			try {
				...
				RequestDispatcher rd = getServletContext().getRequestDispatcher("/inter.jsp");
