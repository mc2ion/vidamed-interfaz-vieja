 ...
 */
@WebServlet(description = "servlet to log in users", urlPatterns = { "/OpenCashBoxServlet" })
public class OpenCashBoxServlet extends HttpServlet {
