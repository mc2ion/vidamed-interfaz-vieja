...
/**
 * Servlet implementation class ShowDiscountServlet
 */
@WebServlet(description = "servlet to log in users", urlPatterns = { "/ShowDiscountServlet" })
