...
public class AddExchangeRate implements DatabaseCommand {
	
	private Long userID;
	private Double value;
	
	public AddExchangeRate(Long userID, Double value){
		this.userID = userID;
		this.value = value;
	}
	...
	public Object executeDatabaseOperation(Connection conn) throws SQLException {
		...
		try {
			ps = conn.prepareStatement("exec dbo.AddExchangeRate " + this.userID + ", " + this.value);
			rs = ps.executeQuery();
