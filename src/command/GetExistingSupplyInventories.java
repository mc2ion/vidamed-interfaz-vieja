...
public class GetExistingSupplyInventories implements DatabaseCommand {

	private Long supplyID;
	
	public GetExistingSupplyInventories(Long supplyID){
	...
	public Object executeDatabaseOperation(Connection conn) throws SQLException {
		...
		try {
			ps = conn.prepareStatement("exec dbo.GetExistingSupplyInventories " + supplyID);
			rs = ps.executeQuery();
