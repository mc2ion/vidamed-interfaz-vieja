...
public class GetSpecialistsByUnit implements DatabaseCommand {
	
	private Long unitId;
	
	public GetSpecialistsByUnit(Long unitId){
		this.unitId = unitId;
	}
	...
	public Object executeDatabaseOperation(Connection conn) throws SQLException {
		...
		try {
			ps = conn.prepareStatement("exec dbo.GetSpecialistsByUnit " + unitId);
			rs = ps.executeQuery();
