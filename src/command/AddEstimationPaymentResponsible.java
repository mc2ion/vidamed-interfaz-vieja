...
public class AddEstimationPaymentResponsible implements DatabaseCommand {
	...
	public AddEstimationPaymentResponsible(Long estimationId, Long paymentRId, String hasGuaranteeL, String isPolicyHolder,
	...
	public Object executeDatabaseOperation(Connection conn) throws SQLException {
		...
		try {
			ps = conn.prepareStatement("exec dbo.AddEstimationPaymentResponsible " + estimationId + ", " + paymentRId +
									  ", " + hasGuaranteeL + ", "+ isPolicyHolder + ",'" + policyCed + "', '" + policyName + "'");
			ps.execute();
		}
		catch(Exception e){
			return 0;
