...
<html>
	<head>
		...
		<title>Imprimir Hospitalización</title>	
	...
	<body id="especial">
		...
		<div id="title" style="font-size:16px; font-weight: bold;"> Hospitalización n° 1001 </div>
		<br>
		...
		<fieldset>
			...
			<label for="name" class="etiq"><span id="idCard">Ubicación: </span></label>UCI<br><br>
		...
		<h3>Protocolos</h3>
		<fieldset>
			<label for="name" class="etiq"><span id="idCard"></span></label> * Histerectomía<br><br>
			<label for="name" class="etiq"><span id="idCard"></span></label> * Colecistectomía<br><br>
			<label for="name" class="etiq"><span id="idCard"></span></label> * Apendicectomía<br>
		</fieldset>
		<br>
		<h3>Servicios</h3>
		<table id="sweetTable">
