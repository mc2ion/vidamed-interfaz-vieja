...
<html>
	<head>
		...
		<title>Detalle protocolo - tratamiento médico</title>
	...
	<body>
		<div id="container">
        	...
        	<div id="content" style="position:absolute;">	
        		<h3 style="color:#006C92;">Detalle protocolo "<%= nameProtocol %>" en tratamiento médico n° <%= request.getParameter("estimationID") %>:</h3>
				<%
