...
<%
	...
	ArrayList<PendingPromptPayment> mfList = (ArrayList<PendingPromptPayment>)request.getAttribute("pp");
						...
						<table class="display" id="example">
							...
							<tbody>			
								<% for (int i = 0; i < mfList.size(); i++){
									PendingPromptPayment pm = mfList.get(i);
								...
								<tr class="gradeA">
									...
									<td><%= status %></td>
									<td>
										<a href="ShowPromptPaymentServlet?id=<%= pm.getMedicalFeeID() %>" style="color: transparent" >
