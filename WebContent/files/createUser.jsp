		  ...
		  <script>
			$(function() {    
            	$('#sbmtButton').click(function(event) { 
            		...
            		else if (!$('#txtSalary').val().match(patternNumber)) {
            			$("#tabs").tabs( "option", "active", 2);
            			alert("El campo 'Salario' sólo debe contener números sin puntos ni espacios en blanco");
            			return;
            		}
			  		...
			  		<form id="form1" name="form1" action="CreateUserServlet">
			  			...
			  			<div id="tabs-3">
			  				<fieldset>
								...
								<input type="number" min="1" name="txtSalary" id="txtSalary" maxlength="6" size="6" required /> <br><br>
