					...
					<ul>
  					...
  					<div id="tabs-1">
					   ...
					   <label> Responsable del Pago:</label>  <input type="text" name="insuranceName" id="insuranceName" value="La Previsora" readonly>
					    <a href="SearchInsuranceServlet?function=editPharmacyEstimation" style="color: #f7941e; font-weight: bold;">
  						...
  						<br>
					   	<table id="sweetTable" style="margin-bottom: 10px;">
					   		...
					   		<tr>
					   			...
					   			<td>Bs. 14321,00</td>
					   			<td>
					   				<a href="EditPharmacyProtocolServlet" style="color: transparent" >
