...
<body>
	<div id="container">
		...
		<div id="content">  
			<h2>Altas Admisión Pendientes:</h2>
			<div id="dt_example">
					<div id="container">
						<div id="demo">
							<table class="display" id="example">
								...
								<tbody>			
									<tr class="gradeA">
										...
										<td>
											<a href="editAdmissionEstimation.jsp" style="color: transparent" >
		...
		<div id="dischargeUser">
			<div id="signup-ct">
				...
				<form action="pendingAdmissionDischarges.jsp" method="post"  onsubmit="return setV(this)">
