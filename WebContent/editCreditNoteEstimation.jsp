...
<html>
	...
	<title>Ver Detalle Prefactura</title>
	...
	<div id="container">
        ...
        <div id="menu">
	    	...
	    	<ul>
            	...
            	<li class="menuitem"><a href="ListAdmissionsServlet">Ver Prefacturas</a></li>
            </ul>
            <div class="menuitemSalir"><a href="LogoutServlet">Salir</a></div>	
        </div>        
		 <jsp:include page="./menu.jsp" />
		<div id="content" style="position:absolute;"> 
			<h2>Ver Detalle Prefactura:</h2>
			<br>
				<div id="tabs">
					<ul>
  					...
  					<div id="tabs-1">
					   ...
					   <label>Médico Tratante: </label> <input type="text" name="doctorName" id="doctorName" value="Ricardo García" readonly>
					    <a href="SearchDoctorServlet?function=editCreditNoteEstimation" style="color: #f7941e; font-weight: bold;">
  					...
  					<div id="tabs-2">
  						<div style="text-align:right;">
	  						<a href="SearchAdmissionServlet?function=editCreditNoteEstimation" style="color: #006c92; font-weight: bold;">
