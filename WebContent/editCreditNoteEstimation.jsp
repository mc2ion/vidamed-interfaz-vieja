	...
	<div id="container">
        ...
        <div id="menu">
	    	...
	    	<ul>
            	...
            	<li class="menuitem"><a href="admission.jsp">Ver Prefacturas</a></li>
            </ul>
					...
					<ul>
  					...
  					<div id="tabs-1">
					   ...
					   <label>Médico Tratante: </label> <input type="text" name="doctorName" id="doctorName" value="Ricardo García" readonly>
					    <a href="searchDoctor.jsp?function=editCreditNoteEstimation" style="color: #f7941e; font-weight: bold;">
  					...
  					<div id="tabs-2">
  						<div style="text-align:right;">
	  						<a href="searchadmission.jsp?function=editCreditNoteEstimation" style="color: #006c92; font-weight: bold;">
