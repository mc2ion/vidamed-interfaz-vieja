...
<html>
	...
	<title>Ecosonograf&iacute;a</title>
							...
							<table class="display" id="example">
								...
								<tbody>			
									...
									<tr class="gradeA">
										...
										<td>											
											<a href="ListPatientEstimationServicesServlet?id=<%= admi.getAdmissionID() %>&servId=2&name=<%= patName %>" style="color: transparent" >
												<img alt="logo" src="./images/meds.png"  height="16" width="16" title="Ver Servicios Presupuestados" />
											</a>
											<a href="ListPatientServicesServlet?id=<%= admi.getAdmissionID() %>&servId=2&name=<%= patName %>" style="color: transparent" >
