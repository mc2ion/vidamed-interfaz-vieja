...
<html>
	...
	<body>
		...
		<div id="menu">
		    	...
		    	<ul>
	            	<li class="menuitem"><a href="ListDoctorsServlet">Ver Especialistas</a></li>
					...
					<ul>
			  		...
			  		<div id="tabs-1">
						<fieldset>
							...
							<input type="text" name="txtName" id="txtName" maxlength="50" size="5" value="López"/> <br><br>
							...
							<input type="text" name="txtCedIdNum" id="txtCedIdNum" maxlength="50" size="18" value="V123456780" /> <br><br>
						</fieldset>						
						<div id="botonera">
			  		...
			  		<div id="tabs-3">
			  			<fieldset>
							...
							<select multiple="multiple" id="my-select" name="my-select[]">
								...
								<option value="356" selected>GINECOLOGÍA CLÍNICA</option>
								...
								<option value="370" selected>ONCOLOGÍA MÉDICA</option>
