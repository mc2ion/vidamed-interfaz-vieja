...
<body>
	<div id="container">
		...
		<div id="menu">
			...
			<ul>
            	<li class="menuitem"><a href="createmedicalTreatment.jsp">Crear Tratamiento Médico</a></li>
            </ul>
							...
							<table class="display" id="example">
								...
								<tbody>			
									<tr class="gradeA">
										...
										<td>
											<a href="editmedicalTreatment.jsp" style="color: transparent" >
		...
		<div id="deleteUser">
			<div id="signup-ct">
				...
				<form action="admission.jsp" method="post"  onsubmit="return setV(this)">
