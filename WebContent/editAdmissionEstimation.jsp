		...
		<div id="header">
         ...
         <div id="menu">
	    	...
	    	<ul>
            	...
            	<li class="menuitem"><a href="pendingAdmissionDischarges.jsp">Ver Altas Pendientes</a></li>
            </ul>
					...
					<ul>
  					...
  					<div id="tabs-1">
					   ...
					   <label> Responsable del Pago:</label>  <input type="text" name="insuranceName" id="insuranceName" value="La Previsora" readonly>
					    <a href="searchInsurance.jsp?function=editAdmissionEstimation" style="color: #f7941e; font-weight: bold;">
  						...
  						<br>
					   	<table id="sweetTable" style="margin-bottom: 10px;">
					   		...
					   		<tr>
					   			...
					   			<td>Bs. 14321,00</td>
					   			<td>
					   				<a href="editAdmissionProtocol.jsp" style="color: transparent" >
