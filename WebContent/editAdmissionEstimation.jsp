		...
		<div id="header">
         ...
         <div id="menu">
	    	...
	    	<ul>
            	...
            	<li class="menuitem"><a href="ListAdmissionDischargesServlet">Ver Altas Pendientes</a></li>
            </ul>
            <div class="menuitemSalir"><a href="LogoutServlet">Salir</a></div>	
        </div>        
		<jsp:include page="./menu.jsp" />
		<div id="content" style="position:absolute;">	  
			<h2>Ver Detalle Alta Pendiente:</h2>
			<br>
				<div id="tabs">
					<ul>
  					...
  					<div id="tabs-1">
					   ...
					   <label>Médico Tratante: </label> <input type="text" name="doctorName" id="doctorName" value="Ricardo García" readonly>
					    <a href="SearchDoctorServlet?function=editAdmissionEstimation" style="color: #f7941e; font-weight: bold;">
					   ...
					   <label> Responsable del Pago:</label>  <input type="text" name="insuranceName" id="insuranceName" value="La Previsora" readonly>
					    <a href="SearchInsuranceServlet?function=editAdmissionEstimation" style="color: #f7941e; font-weight: bold;">
  					...
  					<div id="tabs-2">
  						<div style="text-align:right;">
	  						<a href="SearchAdmissionServlet?function=editAdmissionEstimation" style="color: #006c92; font-weight: bold;">
  						...
  						<br>
					   	<table id="sweetTable" style="margin-bottom: 10px;">
					   		...
					   		<tr>
					   			...
					   			<td>Bs. 14321,00</td>
					   			<td>
					   				<a href="EditAdmissionProtocolServlet" style="color: transparent" >
