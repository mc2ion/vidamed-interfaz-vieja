			...
			if (first != null){
				if (first.indexOf("Payable") > 0){
					if (first == "createAccountPayable"){
						$("#form").attr('action', 'createAccountPayable.jsp#tabs-1');
						$("#form2").attr('action', 'createAccountPayable.jsp#tabs-1');
					}
					else if(first == "editAccountPayable"){
						$("#form").attr('action', 'editAccountPayable.jsp#tabs-1');
						$("#form2").attr('action', 'editAccountPayable.jsp#tabs-1');
					}
