...
<body>
	<div id="container">
		...
		<div id="menu">
			...
			<ul>
            	<li class="menuitem"><a href="createService.jsp">Crear Servicio</a></li>
            </ul>
							...
							<table class="display" id="example">
								...
								<tbody>			
									<tr class="gradeA">
										...
										<td>6.363,20</td>
										<td>
											<a href="editService.jsp" style="color: transparent" >
												<img alt="logo" src="./images/edit.png"  height="16" width="16" title="Editar" />
											</a>
											<a id="go" rel="leanModal" href="#deleteUser" style="color: #f7941e; font-weight: bold;" 
												onclick="return loadVars(1001,'Hospitalización');" >
									...
									<tr class="gradeA">
										...
										<td>
											...
											<a id="go" rel="leanModal" href="#deleteUser" style="color: #f7941e; font-weight: bold;" 
												onclick="return loadVars(1003,'Operación');" >
												<img alt="logo" src="./images/delete.png" height="16" width="16" title="Eliminar"/>
											</a> 
											<br>
										</td>
		...
		<div id="deleteUser">
			<div id="signup-ct">
				...
				<br><br>
				<span>¿Está seguro que desea eliminar el servicio '<span class="cliente"></span>' y su información asociada? </span> <br><br>
				<div id="signup-header">
					<a class="close_x" id="close_x"  href="#"></a>
				</div>
				<form action="services.jsp" method="post"  onsubmit="return setV(this)">
