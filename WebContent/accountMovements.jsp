...
<body>
	<div id="container">
		...
		<div id="deleteUser">
			<div id="signup-ct">
				<h3 id="see_id" class="sprited" > Eliminar Movimiento Cuenta</h3>
				<br><br>
				<span>¿Está seguro que desea eliminar el movimiento '<span class="cliente"></span>' y su información asociada? </span> <br><br>
