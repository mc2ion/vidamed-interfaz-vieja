...
<html>
	...
	<title>Altas Admisión Pendientes</title><link rel="stylesheet" href="http://code.jquery.com/ui/1.10.3/themes/ui-lightness/jquery-ui.css" />
  	<script src="./js/jquery-1.9.1.min.js"></script>
	<script src="http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>
	<script type="text/javascript" src="./js/jquery.leanModal.min.js"></script>
	<link rel="stylesheet" href="/resources/demos/style.css" /><script type="text/javascript" src="./js/formToWizard.js"></script>
...
<body>
	<div id="container">
		...
		<div id="content" style="position:absolute;">	
		       	<form id="SignupForm" action="EditAdmissionEstimationServlet#tabs-2">
		        	<fieldset id="field1">
