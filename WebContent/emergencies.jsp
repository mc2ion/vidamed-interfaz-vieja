	...
	<div id="container">
							...
							<table class="display" id="example">
								...
								<tbody>			
									<tr class="gradeA">
										...
										<td>
											<a href="showEmergency.jsp" style="color: transparent" >
												<img alt="logo" src="./images/detail.png"  height="16" width="16" title="Ver Detalle" />
											</a>
											<a href="editEmergency.jsp" style="color: transparent" >
		...
		<div id="deleteUser">
			<div id="signup-ct">
				...
				<form action="emergencies.jsp" method="post"  onsubmit="return setV(this)">
